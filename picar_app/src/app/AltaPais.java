...
public class AltaPais extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("GESTIÓN DE PAISES");
        ...
        jLabel3.setText("Nombre de país:");
    ...
    public class AltaLocalidadC {
        ...
        ultimoMensajeMySQL="El país "+nombrelocalidad+" fue agregado con éxito al sistema.\nSu ID es: "+registroid+".";
    ...
    public class ModificarLocalidadC{
        ...
        String sql = "UPDATE picar_db.paises SET pais='"+nombrelocalidad+"' WHERE idpaises="+idlocalidades+";";
            try{
                Statement st = LlenarCombo.conexion.createStatement();
                st.executeUpdate(sql);
                ultimoMensajeMySQL="El país N°"+idlocalidades+" fue actualizado con los datos ingresados.";
                ...
                if(registrolocalidad.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "El país N°"+idlocalidades+" ingresado no se encuentra en el sistema.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    jTextField2.setText("");
                }
            } catch (SQLException e) {
            System.out.println(e);
