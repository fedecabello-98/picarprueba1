...
public class AltaProvincia extends javax.swing.JDialog {
    ...
    /** Creates new form AltaProvincia */
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel2.setText("N° de provincia:");
        ...
        jLabel3.setText("Nombre de provincia:");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        MostrarTodasProvincias mostrarlocalidades = new MostrarTodasProvincias();
        this.dispose();
    ...
    public class ModificarLocalidadC{
        ...
        String sql = "UPDATE picar_db.provincias SET provincia='"+nombrelocalidad+"' WHERE idprovincias="+idlocalidades+";";
            try{
                Statement st = LlenarCombo.conexion.createStatement();
                st.executeUpdate(sql);
                ultimoMensajeMySQL="La provincia N°"+idlocalidades+" fue actualizada con los datos ingresados.";
                ResultSet registrolocalidad = st.executeQuery("SELECT * FROM picar_db.provincias WHERE idprovincias="+idlocalidades+";");
                if(registrolocalidad.next()){
                    ...
                    String traerid = registrolocalidad.getString("idprovincias");
                    String traernombre = registrolocalidad.getString("provincia");
                    jTextField1.setText(traerid);
                    jTextField2.setText(traernombre);
                }else{
                    JOptionPane.showMessageDialog(null, "La provincia N°"+idlocalidades+" ingresada no se encuentra en el sistema.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    jTextField2.setText("");
                }
    ...
    public class AltaLocalidadC {
        ...
        String sql = "INSERT INTO picar_db.provincias (provincia) VALUES ('"+nombrelocalidad+"');";
        try {
        Statement st = LlenarCombo.conexion.createStatement();
        st.executeUpdate(sql);
        ResultSet idlocalidad = st.executeQuery("select provincias.idprovincias from picar_db.provincias order by provincias.idprovincias desc limit 1;");
            if(idlocalidad.next()){
        String registroid = idlocalidad.getString("idprovincias");
        ultimoMensajeMySQL="La provincia "+nombrelocalidad+" fue agregada con éxito al sistema.\nSu ID es: "+registroid+".";
        JOptionPane.showMessageDialog(null, ultimoMensajeMySQL, "INFORMACIÓN DEL SISTEMA", JOptionPane.INFORMATION_MESSAGE);
    ...
    public class BuscarLocalidadC{
        ...
        public String buscarLocalidad(String idlocalidades){
            try{
                Statement st = LlenarCombo.conexion.createStatement();
                ResultSet registrolocalidad = st.executeQuery("SELECT * FROM picar_db.provincias WHERE provincias.idprovincias="+idlocalidades+";");
                if(registrolocalidad.next()){
                String traernombre = registrolocalidad.getString("provincia");
                jTextField2.setText(traernombre);
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util
                .logging
                .Logger
                .getLogger(AltaProvincia.class.getName())
                .log(java.util
                         .logging
                         .Level
                         .SEVERE, null, ex);
